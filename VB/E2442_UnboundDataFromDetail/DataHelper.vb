...
Namespace E2442_UnboundDataFromDetail
	Friend Class DataHelper
		Public Shared Function CreateCategoriesTable() As DataTable
			Dim table As New DataTable()
			Dim dataRow As DataRow
			table.Columns.Add("CategoryID", GetType(System.Int32))
			table.Columns.Add("CategoryName", GetType(System.String))
		...
		Public Shared Function CreateProductsTable() As DataTable
			Dim table As New DataTable()
			Dim dataRow As DataRow
			table.Columns.Add("ProductID", GetType(System.Int32))
			table.Columns.Add("ProductName", GetType(System.String))
			table.Columns.Add("CategoryID", GetType(System.Int32))
			table.Columns.Add("QuantityPerUnit", GetType(System.String))
			table.Columns.Add("UnitPrice", GetType(System.Decimal))
			table.Columns.Add("UnitsInStock", GetType(System.Int16))
			dataRow = table.NewRow()
			dataRow("ProductID") = 1
